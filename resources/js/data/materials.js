...
export const OVERWORLD_POOL = [
  ...
  { id: 'smooth_sandstone',        name: 'Smooth Sandstone',        texture: 'sandstone_bottom.png',        pool: 'overworld' },
  ...
  { id: 'smooth_red_sandstone',    name: 'Smooth Red Sandstone',    texture: 'red_sandstone_bottom.png',    pool: 'overworld' },
  ...
  { id: 'oak_wood',          name: 'Oak Wood',          texture: 'oak_log.png',           pool: 'overworld' },
  { id: 'stripped_oak_log',  name: 'Stripped Oak Log',  texture: 'stripped_oak_log.png',   pool: 'overworld' },
  { id: 'stripped_oak_wood', name: 'Stripped Oak Wood', texture: 'stripped_oak_log.png',  pool: 'overworld' },
  ...
  { id: 'birch_wood',          name: 'Birch Wood',          texture: 'birch_log.png',           pool: 'overworld' },
  { id: 'stripped_birch_log',  name: 'Stripped Birch Log',  texture: 'stripped_birch_log.png',   pool: 'overworld' },
  { id: 'stripped_birch_wood', name: 'Stripped Birch Wood', texture: 'stripped_birch_log.png',  pool: 'overworld' },
  ...
  { id: 'spruce_wood',          name: 'Spruce Wood',          texture: 'spruce_log.png',           pool: 'overworld' },
  { id: 'stripped_spruce_log',  name: 'Stripped Spruce Log',  texture: 'stripped_spruce_log.png',   pool: 'overworld' },
  { id: 'stripped_spruce_wood', name: 'Stripped Spruce Wood', texture: 'stripped_spruce_log.png',  pool: 'overworld' },
  ...
  { id: 'jungle_wood',          name: 'Jungle Wood',          texture: 'jungle_log.png',           pool: 'overworld' },
  { id: 'stripped_jungle_log',  name: 'Stripped Jungle Log',  texture: 'stripped_jungle_log.png',   pool: 'overworld' },
  { id: 'stripped_jungle_wood', name: 'Stripped Jungle Wood', texture: 'stripped_jungle_log.png',  pool: 'overworld' },
  ...
  { id: 'acacia_wood',          name: 'Acacia Wood',          texture: 'acacia_log.png',           pool: 'overworld' },
  { id: 'stripped_acacia_log',  name: 'Stripped Acacia Log',  texture: 'stripped_acacia_log.png',   pool: 'overworld' },
  { id: 'stripped_acacia_wood', name: 'Stripped Acacia Wood', texture: 'stripped_acacia_log.png',  pool: 'overworld' },
  ...
  { id: 'dark_oak_wood',          name: 'Dark Oak Wood',          texture: 'dark_oak_log.png',           pool: 'overworld' },
  { id: 'stripped_dark_oak_log',  name: 'Stripped Dark Oak Log',  texture: 'stripped_dark_oak_log.png',   pool: 'overworld' },
  { id: 'stripped_dark_oak_wood', name: 'Stripped Dark Oak Wood', texture: 'stripped_dark_oak_log.png',  pool: 'overworld' },
  ...
  { id: 'mangrove_wood',          name: 'Mangrove Wood',          texture: 'mangrove_log.png',           pool: 'overworld' },
  { id: 'stripped_mangrove_log',  name: 'Stripped Mangrove Log',  texture: 'stripped_mangrove_log.png',   pool: 'overworld' },
  { id: 'stripped_mangrove_wood', name: 'Stripped Mangrove Wood', texture: 'stripped_mangrove_log.png',  pool: 'overworld' },
  ...
  { id: 'cherry_wood',          name: 'Cherry Wood',          texture: 'cherry_log.png',           pool: 'overworld' },
  { id: 'stripped_cherry_log',  name: 'Stripped Cherry Log',  texture: 'stripped_cherry_log.png',   pool: 'overworld' },
  { id: 'stripped_cherry_wood', name: 'Stripped Cherry Wood', texture: 'stripped_cherry_log.png',  pool: 'overworld' },
  ...
  // --- Wood: Bamboo (1.20) ---
  { id: 'bamboo_block',          name: 'Bamboo Block',          texture: 'bamboo_block.png', pool: 'overworld' },
  ...
  { id: 'furnace',           name: 'Furnace',           texture: 'furnace_front.png',        pool: 'overworld' },
  { id: 'blast_furnace',     name: 'Blast Furnace',     texture: 'blast_furnace_front.png',  pool: 'overworld' },
  { id: 'smoker',            name: 'Smoker',            texture: 'smoker_front.png',         pool: 'overworld' },
  ...
  { id: 'chiseled_bookshelf',name: 'Chiseled Bookshelf',texture: 'chiseled_bookshelf_occupied.png',       pool: 'overworld' },
  ...
  { id: 'dispenser',         name: 'Dispenser',         texture: 'dispenser_front.png', pool: 'overworld' },
  { id: 'dropper',           name: 'Dropper',           texture: 'dropper_front.png', pool: 'overworld' },
...
export const NETHER_POOL = [
  ...
  { id: 'crimson_hyphae',         name: 'Crimson Hyphae',         texture: 'crimson_stem.png',         pool: 'nether' },
  { id: 'stripped_crimson_hyphae',name: 'Stripped Crimson Hyphae',texture: 'stripped_crimson_stem.png',pool: 'nether' },
  ...
  { id: 'warped_hyphae',          name: 'Warped Hyphae',          texture: 'warped_stem.png',          pool: 'nether' },
  { id: 'stripped_warped_hyphae', name: 'Stripped Warped Hyphae', texture: 'stripped_warped_stem.png', pool: 'nether' },
  ...
  { id: 'smooth_quartz_slab', name: 'Smooth Quartz Slab', texture: 'quartz_block_bottom.png',      pool: 'nether' },
  { id: 'smooth_quartz_stairs',name: 'Smooth Quartz Stairs',texture: 'quartz_block_bottom.png',    pool: 'nether' },
